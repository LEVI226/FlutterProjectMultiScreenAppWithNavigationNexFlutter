...
void main() {
  testWidgets('bottom nav switches between Home, Discover, Favorites, and Profile', (tester) async {
    ...
    await tester.pumpWidget(SavorlyApp(store: store, themeController: themeController));
